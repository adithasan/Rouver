...
namespace NinjaController {
  ...
  public class NinjaController : MonoBehaviour {
    ...
    public LeftJoystick joystickscript = GameObject.Find("Left Joystick").GetComponent<LeftJoystick>();
    ...
    private void ProcessInput() {
      ...
      GameObject.Find("JumpButton").GetComponent<JumpScript>();
      bool isKeyDownJump = JumpScript.jumpbuttonpressed;
      Vector3 joystick_input_vector =  joystickscript.GetInputDirection();
      float joystick_x = joystick_input_vector.x;
      float inputAxisX = joystick_x;
